...
/** Contact section email form component */
				...
				<div className="flex-grow flex justify-end">
					...
					>
						...
						<svg
							...
							className={`stroke-current ${is_sending_email || is_email_sent ? "hidden" : "inline"
								}`}
						>
						...
						<svg
							...
							strokeLinecap="round"
							strokeLinejoin="round"
							className={`stroke-current animate-spin ${is_sending_email ? "inline" : "hidden"
								}`}
						>
						...
						<svg
							...
							strokeLinecap="round"
							strokeLinejoin="round"
							className={`stroke-current ${is_email_sent && !is_sending_email ? "inline" : "hidden"
								}`}
						>
